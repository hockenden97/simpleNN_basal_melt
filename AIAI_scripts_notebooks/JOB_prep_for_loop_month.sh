...
path_python=/bettik/ockendeh/SCRIPTS/simpleNN_basal_melt/AIAI_scripts_notebooks/NN_prep_input_OPM0263_month.py
...
path_jobname=$path_${simulation}_${year}_${month}
echo "Running these variables: " $path_jobname
echo "path" $path
path_sh_file=$path_jobid${simulation}_${year}_${month}
path_sh_local=$path_local${simulation}_${year}_${month}
...
python -u $path_python ${year} ${month} 2>&1 
